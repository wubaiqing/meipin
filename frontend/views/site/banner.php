<div class="newuserbanner1" id="shortcuts" style="">
    <div class="fi07_1">
        <ul style="width: 3920px;">
            <li class="current" data-id="0"><img src="http://www.meipin.com/static/images/1.png"></li>
            <li data-id="1"><img src="http://www.meipin.com/static/images/2.png"></li>
            <li data-id="2"><img src="http://www.meipin.com/static/images/3.png"></li>
            <li data-id="3"><img src="http://www.meipin.com/static/images/4.png"></li>
        </ul>
