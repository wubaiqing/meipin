<div id="nav">
	<div class="two">
		<ul>
			...
			<li><a href="<?php echo $this->createUrl('exchange/index');?>" class="<?php echo (Yii::app()->controller->id == 'exchange' && $this->action->id == 'index' || $cat == 0) ? 'on' : ''; ?>">积分兑换</a></li>
                        <li><a class="<?php echo (Yii::app()->controller->id == 'site' && $cat == 1003) ? 'on' : ''; ?>" href="<?php echo $this->createUrl('site/raffle');?>">幸运抽奖<i></i></a></li>
