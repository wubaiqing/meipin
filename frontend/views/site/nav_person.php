<div id="nav">
	<div class="two">
		...
		<p><span><img src="/static/images/face.png"></span> <a href="javascript:;" class="signin <?php $isSignDay = User::isSignDay(); echo !$isSignDay ? 'qiandao' : 'cheng'; ?>"><i></i><i class="icon-mini"></i><img src="/static/images/pen_03_01.png"><i id='jryq' style='font-family: "微软雅黑";font-size: 12px;color: #FFF;line-height: 36px;display: block;'><?php $isSignDay = User::isSignDay(); echo !$isSignDay ? '签到领积分' : '今日已签&nbsp;&nbsp;&nbsp;&nbsp;'; ?></i></a></p>
