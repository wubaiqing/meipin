...
<div id="content" class="wp">
    ...
    <div class="right dhdeal" style="float:right">
        ...
        <div class="Commodity">
            <div class="tit"><h3 class="current" onclick="setTab('qh', 1, 2)" id="qh1">兑奖规则</h3><h3 onclick="setTab('qh', 2, 2)" id="qh2">兑换记录(<em><?php echo $logList['pager']->getItemCount()?></em>)</h3></div>
