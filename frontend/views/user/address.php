                        ...
                        <tbody>
                            <tr align="center">
                                ...
                                <td height="32" align="left">
                                    <input type="text" value="" id="consignee_name" name="consignee_name" class="text"><em>*您的收货姓名</em>
                                </td>
                            </tr>
                            <tr align="center">
                                <td bgcolor="#F9FAFC" align="right">
                                ...
                                <td height="32" align="left">
                                    <input type="text" class="text" value="" id="phone_number" name="phone_number">
                                    <em>*收货时快递联系电话，很重要。</em>
                                </td>
                            </tr>
                            ...
                            <tr align="center" class="color">
                                ...
                                <td height="32" align="left">
                                    <input type="text" class="text" value="" id="zipcode" name="zipcode">
                                </td>
                            </tr>
                            <tr align="center" class="color">
