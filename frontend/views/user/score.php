    ...
    <div class="user_r r">
        <div class="box admin hei">
            ...
            <div class="info">
                ...
                <h6><a href="/help/index" target="_blank" class="r">积分规则说明</a><a href="/user/score" class="current">积分明细</a>|<a href="/user/score_add">积分增加</a>|<a href="/user/score_con">积分消耗</a></h6>
                <table cellspacing="1" cellpadding="0" border="0" bgcolor="#DFE2E7" class="table_user">
                    ...
                    <tr align="center">
                        <td bgcolor="#F9FAFC">2014-05-04 15:27:55</td>
                        <td>签到奖励</td>
                        <td><strong style="color:#FF4E00">1</strong></td>
                    </tr>				</tbody>
                </table>
