<div class="today-goods-list">
    ...
    <div class="area">
        ...
        foreach ($goods as $item) :
            $goodsUrl =Yii::app()->createUrl("exchange/reffle",['id'=>$item['id']]);
            ?>
            <div class="dealbox">
                <div class="deal figure1 zt1">
                    <div class="">
                        ...
                        <h4>
                            ...
                            <a class="raffle_start" href="<?php echo $goodsUrl?>" target="_blank">我要抽奖</a>
                        </h4>
...
<div id="contentD" class="area">
    <a href="<?php echo Yii::app()->createUrl("site/raffle",['cat'=>$cat,'t'=>'history'])?>" target="_blank">查看历史抽奖活动&gt;&gt;</a>
</div>
