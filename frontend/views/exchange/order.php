...
<div id="confirm_exchange" class="exchange area">
  ...
  <div class="toptxt">
    <p>
      广东省 肇庆市 广宁县 的功夫的故事  (额鹅鹅鹅收)  13666666666  
    </p>
    <p>
      <a class="modify_address" href="javascript:void(0)">修改收货地址</a>
    </p>
  </div>
  <ul class="clear ulbor modify_form" style="display: none;">
    <form accept-charset="UTF-8" action="/profile/address/28008" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓"><input name="_method" type="hidden" value="put"><input name="authenticity_token" type="hidden" value="SHVx8KPwqtNhU3cDANmmmpahohXHTv/vPXXoA9iLS/o="></div>
...
<li class="tj">
  ...
  <div class="paycls">
    ...
    <p>
      <em>0元包邮</em>
      <strong>1.</strong>为了更好的回馈折800会员，所有礼品不收取任何费用，我们包邮为您送到家<br>
  ...
  <div class="confcls">
    ...
    <form accept-charset="UTF-8" action="/jifen/welfare/exchange" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓"><input name="authenticity_token" type="hidden" value="SHVx8KPwqtNhU3cDANmmmpahohXHTv/vPXXoA9iLS/o="></div>
      <div class="gift">
        <p><span>礼品详情</span><span>花费积分</span></p>
        <div class="clear">
          <dl class="ginfo">
            <dt><a href="/jifen/welfare/0yuanbaoyo_129424" target="_blank"><img src="http://z2.tuanimg.com/upload/tao_jifen_deal/image/129424/small_webp_25cba1d08981f4acb280c651d2a6a155.jpg"></a></dt>
            <dd>
              <span class="maxh40"><a target="_blank" href="/jifen/welfare/0yuanbaoyo_129424">【0元包邮】幼儿园生日礼物实用男送女生小小礼品新奇特别创意家居日用品百货</a></span>
              <span>132244</span>
              <input id="join_id" name="join_id" type="hidden" value="132244">
              <input id="id" name="id" type="hidden" value="129424">
            </dd>
          </dl>
          <dl class="jifn" info="d,129424,1400115600000,1398753000000,2">
          <dt><em>599</em><span></span></dt>
            <dd>提示：兑换礼品后您将减少599积分，一旦兑换成功，积分将不退还！请确定喜欢此礼品再兑换</dd>
          </dl>
        </div>
      </div>
