...
?>
    ...
    <div class="control-group">
        <?php echo $form->labelEx($model,'relation_website', array('class' => 'control-label')); ?>
        <div class="controls">
            <?php echo $form->dropDownList($model, 'relation_website', CHtml::listData(Store::getAll(), 'id', 'name'), array('empty' => '请选择')); ?>
        </div>
    </div>
...
<script src="<?php echo Yii::app()->request->baseUrl;?>/scripts/goods/add.js?v=wubaiqing.1.5.3"></script>
